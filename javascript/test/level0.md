...
function solution(spell, dic) {
    const answer = dic.map(e => spell.map(x => e.includes(x)).every(y => y === true)).some(z => z === true) ? 1 : 2;
    return answer;
}
*/

const solution = (spell, dic) => dic.map(e => spell.map(x => e.includes(x)).every(y => y === true)).some(z => z === true) ? 1 : 2;
```
